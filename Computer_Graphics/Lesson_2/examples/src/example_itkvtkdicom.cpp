...
int main(int argc, char ** argv)
{
	...
	//std::string dirName = "C:\\dev\\Source\\LABS\\Computer_Graphics\\Lesson_2\\data\\BrainTumorMRI\\";
	std::string dirName = "C:\\dev\\Source\\LABS\\Computer_Graphics\\Lesson_2\\data\\BrainTumorPET\\";
